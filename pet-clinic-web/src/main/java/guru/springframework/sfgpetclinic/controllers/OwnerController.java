...
public class OwnerController {
	...
	@GetMapping("/new")
	public String initCreationForm(Model theModel) {
	...
	@PostMapping("/new")
	public String postCreationForm(@Valid Owner owner, BindingResult result, Model theModel) {
		if(result.hasErrors()) {
			return VIEWS_OWNER_CREATE_OR_UPDATE_FORM;
		} else {
	...
	public String initUpdateOwnerForm(@PathVariable Long ownerId, Model theModel) {
		
		theModel.addAttribute(ownerService.findById(ownerId));
